...
func Limit[Slice ~[]T, T any](xs Slice, offset, limit int) Slice {
...
func Indirect[Slice ~[]T, T any](xs Slice, from, to int) Slice {
...
// Does not panic on overflow, shrinks the indices to fit the slice size.
func Forward[Slice ~[]T, T any](xs Slice, from, to int) Slice {
