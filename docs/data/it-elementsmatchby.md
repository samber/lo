...
words1 := slices.Values([]string{"hello", "world", "go", "lang"})
words2 := slices.Values([]string{"short", "longer", "golang", "python"})
...
items1 := slices.Values([]string{"apple", "apricot", "banana", "blueberry"})
items2 := slices.Values([]string{"ant", "anchor", "boat", "berry"})
...
emails1 := slices.Values([]Email{
    {Address: "user1@example.com"},
    {Address: "user2@gmail.com"},
    {Address: "user3@example.com"},
})
emails2 := slices.Values([]Email{
...
numbers1 := slices.Values([]int{1, 2, 3, 4, 5, 6})
numbers2 := slices.Values([]int{7, 8, 9, 10, 11, 12})
...
strings1 := slices.Values([]string{"Hello", "World", "GO"})
strings2 := slices.Values([]string{"hello", "world", "go"})
...
products1 := slices.Values([]Product{
    {Name: "Book", Price: 19.99},
    {Name: "Pen", Price: 1.99},
    {Name: "Laptop", Price: 999.99},
})
products2 := slices.Values([]Product{
...
students1 := slices.Values([]Student{
    {Name: "Alice", Age: 8},
    {Name: "Bob", Age: 15},
    {Name: "Charlie", Age: 20},
})
students2 := slices.Values([]Student{
    {Name: "Diana", Age: 25},
    {Name: "Eve", Age: 10},
    {Name: "Frank", Age: 12},
})
