...
list1 := slices.Values([]int{1, 2, 3, 4, 5})
list2 := slices.Values([]int{5, 4, 3, 2, 1})
match := it.ElementsMatch(list1, list2)
// match: true

// Lists with different elements
list1 = slices.Values([]int{1, 2, 3, 4, 5})
list2 = slices.Values([]int{1, 2, 3, 4, 6})
match = it.ElementsMatch(list1, list2)
// match: false (5 vs 6)

// Lists with duplicates
list1 = slices.Values([]int{1, 2, 2, 3, 4})
list2 = slices.Values([]int{4, 3, 2, 1, 2})
match = it.ElementsMatch(list1, list2)
// match: true (both have two 2's)

// Lists with different number of duplicates
list1 = slices.Values([]int{1, 2, 2, 3, 4})
list2 = slices.Values([]int{4, 3, 2, 1, 1})
match = it.ElementsMatch(list1, list2)
// match: false (list1 has two 2's, list2 has two 1's)

// Empty lists
empty1 := slices.Values([]int{})
empty2 := slices.Values([]int{})
...
// String lists
words1 := slices.Values([]string{"hello", "world", "go"})
words2 := slices.Values([]string{"go", "hello", "world"})
match = it.ElementsMatch(words1, words2)
// match: true

words1 = slices.Values([]string{"hello", "world", "go"})
words2 = slices.Values([]string{"go", "hello", "golang"})
match = it.ElementsMatch(words1, words2)
// match: false
...
people1 := slices.Values([]Person{
    {Name: "Alice", Age: 30},
    {Name: "Bob", Age: 25},
    {Name: "Charlie", Age: 35},
})
people2 := slices.Values([]Person{
    {Name: "Charlie", Age: 35},
    {Name: "Alice", Age: 30},
    {Name: "Bob", Age: 25},
})
...
// Different lengths
list1 = slices.Values([]int{1, 2, 3})
list2 = slices.Values([]int{1, 2, 3, 4})
match = it.ElementsMatch(list1, list2)
// match: false

// Same elements but different counts
list1 = slices.Values([]int{1, 1, 2, 3})
list2 = slices.Values([]int{1, 2, 2, 3})
match = it.ElementsMatch(list1, list2)
// match: false (list1 has two 1's, list2 has two 2's)

// Boolean values
bools1 := slices.Values([]bool{true, false, true})
bools2 := slices.Values([]bool{true, true, false})
match = it.ElementsMatch(bools1, bools2)
// match: true

// Different boolean counts
bools1 = slices.Values([]bool{true, false, true})
bools2 = slices.Values([]bool{true, false, false})
match = it.ElementsMatch(bools1, bools2)
// match: false

// Lists with same single element
list1 = slices.Values([]int{42})
list2 = slices.Values([]int{42})
match = it.ElementsMatch(list1, list2)
// match: true

// Lists with different single elements
list1 = slices.Values([]int{42})
list2 = slices.Values([]int{43})
match = it.ElementsMatch(list1, list2)
// match: false
```