...
// With strings
words := slices.Values([]string{"apple", "banana", "cherry", "date", "elderberry"})
wordSamples := it.SamplesBy(words, 2, rng.Intn)
// wordSamples: sequence of 2 random unique words
...
peopleSamples := it.SamplesBy(people, 3, rng.Intn)
// peopleSamples: sequence of 3 random unique people
