...
func TestSubstring(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "invalid utf8 positive offset short tail", str: "\xffa", offset: 1, length: 1, expected: "a"},
		{name: "invalid utf8 positive offset", str: "a\xffbc", offset: 2, length: 2, expected: "bc"},
		{name: "invalid utf8 positive offset repeated", str: "\xff\xffb", offset: 1, length: math.MaxUint, expected: "�b"},
		{name: "valid rune error positive offset", str: "�ab", offset: 1, length: 2, expected: "ab"},
