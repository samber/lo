...
func TestContainsInt16x8(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []int16
...
func TestContainsInt32x4(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []int32
...
func TestContainsInt64x2(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []int64
...
func TestContainsUint8x16(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []uint8
...
func TestContainsUint16x8(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []uint16
...
func TestContainsUint32x4(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []uint32
...
func TestContainsUint64x2(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []uint64
...
func TestContainsFloat32x4(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []float32
...
func TestContainsFloat64x2(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name       string
		collection []float64
...
func TestSSEContainsTypeAlias(t *testing.T) {
	requireAVX512(t)
...
func TestSSEContainsConsistency(t *testing.T) {
	requireAVX512(t)
	testCases := []struct {
		name    string
		int8    []int8
