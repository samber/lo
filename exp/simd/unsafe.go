...
//
//go:nosplit
func unsafeSliceInt8[T ~int8](collection []T, length int) []int8 {
...
//
//go:nosplit
func unsafeSliceInt16[T ~int16](collection []T, length int) []int16 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceInt32[T ~int32](collection []T, length int) []int32 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceInt64[T ~int64](collection []T, length int) []int64 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceUint8[T ~uint8](collection []T, length int) []uint8 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceUint16[T ~uint16](collection []T, length int) []uint16 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceUint32[T ~uint32](collection []T, length int) []uint32 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceUint64[T ~uint64](collection []T, length int) []uint64 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceFloat32[T ~float32](collection []T, length int) []float32 {
	// bearer:disable go_gosec_unsafe_unsafe
...
//
//go:nosplit
func unsafeSliceFloat64[T ~float64](collection []T, length int) []float64 {
	// bearer:disable go_gosec_unsafe_unsafe
