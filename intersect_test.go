...
func TestIntersect(t *testing.T) {
	...
	is.Equal(result0, []int{})
	is.Equal(result1, []int{1})
	is.Equal(result2, []int{0, 2})
	is.Equal(result3, []int{0})
	is.Equal(result4, []int{})
	is.Equal(result5, []int{0})
	is.Equal(result6, []int{0})
	is.Equal(result7, []int{0})
	is.Equal(result8, []int{})
}
