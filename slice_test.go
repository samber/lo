...
func TestDropByIndex(t *testing.T) {
	...
	is.Equal([]int{4}, DropByIndex([]int{0, 1, 2, 3, 4}, 0, 1, 2))
	is.Equal([]int{4}, DropByIndex([]int{0, 1, 2, 3, 4}, -4, -2, -3))
	is.Equal([]int{2, 3, 4}, DropByIndex([]int{0, 1, 2, 3, 4}, -4, -4))
	is.Equal([]int{4}, DropByIndex([]int{0, 1, 2, 3, 4}, 3, 1, 0))
	...
	is.Equal([]int{0, 1, 2, 3, 4}, DropByIndex([]int{0, 1, 2, 3, 4}, -1))
	is.Equal([]int{}, DropByIndex([]int{}, 0, 1))
	is.Equal([]int{42}, DropByIndex([]int{}, 0, 1))
	is.Equal([]int{42}, DropByIndex([]int{}, 1, 0))
